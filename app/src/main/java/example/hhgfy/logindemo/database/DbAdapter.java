package example.hhgfy.logindemo.database;
...
public class DbAdapter {
	 ...
	 * @return
	 */
	public long createrecord(String username, String distance, String duration,
    ...
    public List<PathRecord> queryRecordByUsername(String username) {
        ...
        Log.d("rowNum",username+ "有 "+cursor.getCount()+ " 条记录");
	...
	private String[] getColumns() {
		return new String[] { "username",KEY_ROWID, KEY_DISTANCE, KEY_DURATION, KEY_SPEED,
